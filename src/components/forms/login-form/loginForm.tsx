...
import { writeAdminToLocalStorage } from "src/redux/actions/adminActions";
import { writeUserToLocalStorage } from "src/redux/actions/userActions";
import { IAuthFormValues } from "src/types/User";
...
function LoginForm(): ReturnType<React.FC> {
