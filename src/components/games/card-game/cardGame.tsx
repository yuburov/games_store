    ...
    <div className={style.card}>
      <div className={style.front}>
        ...
        <div className={style.stars}>
          <Rating initialValue={rating} iconsCount={5} fillColor="gold" size={20} />
        </div>
      </div>
      <div className={style.back}>
        ...
        {roleAdmin ? (
          <div className={btnStyle.buttons}>
            ...
            <EditCardForm subscription={{ values: true }} id={id} display={displayButtonEditCard} buttonTitle="Edit" />
          </div>
        ) : (
          <button type="button" className={btnStyle.btn} onClick={handleClick}>
            Add to cart
...
const areEqualCardGameProps = (prevCardGame: ICard, nextCardGame: ICard) =>
